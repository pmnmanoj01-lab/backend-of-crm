...
import { deleteUser, getAllUsers, getUserById, getUserPermissions, registerUser, updatePermissions, updateUser, updateUserStatus } from "../controllers/adminController.js";
...
adminRoute.put("/update-status/:id", authMiddleware,checkAccess([feature.team]), updateUserStatus);
